...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen text-white">
      ...
      >
        ...
        <aside className="w-44 sm:w-52 bg-black/45 backdrop-blur-md border-r border-white/10 flex-shrink-0">
          <div className="px-3 py-4 border-b border-white/10">
            ...
            <p className="text-center text-sm leading-snug text-white px-1">
              States in orange are currently being serviced, more states coming
              soon
            </p>
          ...
          <div ref={statesList} style={{ ...gridBackground, marginTop: "-8px" }}>
            <ul className="text-base leading-[28px] text-center">
                ...
                >
                  {s === "North Carolina" ? (
                    <Link
                      ...
                      className="inline-flex items-center justify-center rounded-full bg-orange-500 px-3 h-[24px] text-white font-bold leading-none hover:bg-orange-400 transition-colors text-base"
                    >
                      North Carolina
                    </Link>
                  ) : (
        ...
        <aside className="w-44 sm:w-52 bg-black/45 backdrop-blur-md border-r border-white/10 flex-shrink-0">
          <div className="px-3 py-4 border-b border-white/10">
            ...
            <p className="mt-1 text-center text-xs invisible select-none px-1">
              placeholder
            </p>
          </div>

          <div className="flex justify-between px-2 pt-1 pb-1 text-sm text-yellow-200 font-semibold border-b border-white/10 bg-black/60 backdrop-blur-md">
      ...
      {/* MAIN CONTENT */}
      <div className="relative z-20 ml-[26rem] pr-6">
        <div className="max-w-[900px] mx-auto flex flex-col items-center gap-6 mt-[80px] pb-10">
          {/* Logo */}
          ...
          <div className="w-full max-w-[650px]">
            <div className="rounded-2xl bg-black/55 backdrop-blur-md p-8 shadow-2xl w-full">
              ...
              <div className="flex justify-center">
                <Link
                  href="/plans"
                  className="inline-flex items-center justify-center rounded-full bg-yellow-400 px-6 py-2 text-black font-semibold shadow-lg hover:bg-yellow-300 hover:shadow-xl hover:-translate-y-[1px] transition-all duration-150"
                >
                  Become a Member
                </Link>
              </div>
